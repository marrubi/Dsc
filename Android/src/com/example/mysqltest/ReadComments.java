...
public class ReadComments extends ListActivity {
	...
	// testing on Emulator:
	private static final String READ_COMMENTS_URL = "http://192.168.0.103:81/webservice/comments.php";
	...
	private void updateList() {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Toast.makeText(ReadComments.this, "You Clicked at "+mCommentList.get(+position).get("title"), Toast.LENGTH_SHORT).show();
